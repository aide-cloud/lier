...
const parseMarkdownAttributes_1 = __importDefault(require("./utils/parseMarkdownAttributes"));
...
function default_1(rawContent) {
    ...
    const { headerHtml, title, description, attributes, markdown: markdownContent, } = (0, parseMarkdownAttributes_1.default)(rawContent, (0, is_1.isObject)(loaderOptions.autoHelmet) && loaderOptions.autoHelmet.formatTitle);
    // Compile changelog
    if (attributes.changelog) {
        return (0, changelog_1.default)(markdownContent, headerHtml);
    }

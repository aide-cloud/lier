...
exports.default = {
    ...
    TIP_WEBPACK_ALIAS_COLLECT_RESULT: 'The following Webpack Resolve Alias information will be applied automatically (extend the webpack config to unapply Alias automatically): ',
    TIP_REGENERATE_ENTRY_BY_GLOB: 'The dependency file has been detected and the entry file is being regenerated',
    TIP_REGENERATE_ENTRY_BY_CONFIG: 'The site configuration has been detected, and the entry file is being regenerated',
    TIP_USE_THEME_FROM_REMOTE_GROUP_CONFIG_ING: 'Try to get group theme config from remote...',
    TIP_USE_THEME_FROM_REMOTE_GROUP_CONFIG_DONE: (groupName, themeName) => `Found theme config matches 「${groupName}」. Theme 「${themeName}」 will be automatically applied`,
